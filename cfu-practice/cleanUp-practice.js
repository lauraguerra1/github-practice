...
unless the variable will serve a later purpose within the function. 
*/
...
/* 
Actions: 
1. Move opening curly bracket to the same line as the function statement, and move the closing curly bracket to 
the beginning of it's line. 
2. Use tab to nest all lines of the code block inside the function, remove the blank line, and add a semicolon 
at the end of the last line of the code block. 
3. Write code to cal the function. 
 
Reason actions 1 & 2: To follow conventions and best practices. 
Reason for action 3: To instruct the interpreter to carry out the instructions in the function. 
*/